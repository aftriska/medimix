...
<table cellpadding="1" cellspacing="1">
	...
	<tr>
		...
		<td>:</td>
		<td><input class="form-control" type="password" name="cur_password" value=""/></td>
		<td><font color="#D22325"><?php echo form_error('cur_password'); ?></font></td>
	</tr>
	<tr>
		<td><label for="password"/>New Password</td>
		<td>:</td>
		<td><input class="form-control" type="password" name="new_password" value=""/></td>
		<td><font color="#D22325"><?php echo form_error('new_password'); ?></font></td>
	</tr>
	<tr>
		<td><label for="password"/>Re-type New Password</td>
		<td>:</td>
		<td><input class="form-control" type="password" name="retype_password" value=""/></td>
		<td><font color="#D22325"><?php echo form_error('retype_password'); ?></font></td>
	</tr>
	<tr><td colspan="4">&nbsp;</td></tr>
	<tr>
		<td colspan="3"><input class="btn btn-success" type="submit" name="save_btn" value="Save"></td>
		<td></td>
	</tr>
</table>
</form>
